                ...
                <div className='shop_heading_sort_area'>
                  ...
                  <div className='sort_main_area'>
                    ...
                    <select className='form-select'>
                      <option selected>Show: 20 items</option>
                      <option value='1'>Show: 30 items</option>
                      <option value='2'>Show: 50 items</option>
                    </select>
                  </div>
                </div>
                  ...
                  <div className='row'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-5.png' alt='img' />
                          </a>
                          <span className='shop_badge in_sold'>Sold</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-6.png' alt='img' />
                          </a>
                          <span className='shop_badge in_offer'>20% off</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-7.png' alt='img' />
                          </a>
                          <span className='shop_badge in_stock'>In stock</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-8.png' alt='img' />
                          </a>
                          <span className='shop_badge in_sold'>Sold</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-9.png' alt='img' />
                          </a>
                          <span className='shop_badge in_offer'>20% off</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-10.png' alt='img' />
                          </a>
                          <span className='shop_badge in_stock'>In stock</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-11.png' alt='img' />
                          </a>
                          <span className='shop_badge in_sold'>Sold</span>
                        </div>
                        <div className='shop_item_content'>
                    ...
                    <div className='col-lg-4 col-md-6 col-sm-12 col-12'>
                      <div className='shop_main_item'>
                        <div className='shop_item_img'>
                          <a href='shop-details.html'>
                            <img src='assets/img/shop/shop-12.png' alt='img' />
                          </a>
                          <span className='shop_badge in_offer'>20% off</span>
                        </div>
                        <div className='shop_item_content'>
